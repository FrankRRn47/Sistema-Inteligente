...
class EmotionDetector:
    ...
    def __init__(self):
        ...
        # Load the best model from the tracked directory
        weights_path = self.base_dir / 'model_weights.h5'
        self.model = load_model(weights_path)

        self.haarcascade_path = self.base_dir / 'haarcascade_frontalface_default.xml'
        self.session_stream_dir = self.base_dir / 'session_stream'
        self.session_stream_dir.mkdir(parents=True, exist_ok=True)
        ...
        stream_file = self.session_stream_dir / f'session_{self.timestamp}.mp4'
        self.out = cv2.VideoWriter(str(stream_file),
    ...
    def run(self):
        ...
        self.img_path = self.base_dir / 'emotion_class'
        ...
        while True:
            ...
            if self.button1_pressed:
                # detect face
                face_cascade = cv2.CascadeClassifier(str(self.haarcascade_path))
